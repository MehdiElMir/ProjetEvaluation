...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 07 juin 2023 à 21:42
...
(2, 'action test1', 'affichage de l\'action', '2023-05-24', 1, 8, 1),
(5, 'bbbb', 'uuuuu', '2023-05-24', 1, 6, 1),
(7, 'xcvbnm,./', 'cvbnm,.', '2023-05-24', 1, 6, 1),
(12, 'cnm,', 'hhh', '2023-05-24', 1, 8, 1),
(13, 'action test 2 juin 2023', 'test body///action test 2 juin 2023', '2023-06-02', 1, 6, 1),
(14, 'action test 3 juin 2023', 'test body///action test 3 juin 2023', '2023-06-02', 1, 6, 1),
(15, 'action test 4 juin 2023', 'test body/// 4action test 3 juin 2023', '2023-06-02', 1, 6, 1),
(16, 'action test 5  --3 juin 2023', 'body action test 5  --3 juin 2023', '2023-06-02', 1, 6, 1);
...
(1, 1, 1, 1, 'rien', '2023-04-18 11:40:57'),
...
(11, 31, 1, 5, 'GOOD', '2023-05-23 14:05:59'),
(125, 34, 7, 3, 'test commentaire', '2023-05-23 18:21:05'),
(126, 29, 7, 2, 'test commmentaire2', '2023-05-23 18:21:05'),
(128, 31, 16, 1, 'test commentaire 2', '2023-05-23 18:30:27'),
(129, 26, 17, 2, NULL, '2023-05-23 20:32:28'),
(131, 1, 16, 5, NULL, '2023-05-23 20:37:20'),
(132, 30, 17, 2, NULL, '2023-05-23 20:37:20');
...
--
ALTER TABLE `response`
  MODIFY `id_response` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
ALTER TABLE `surveyquestion`
  MODIFY `id_survey_question` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
